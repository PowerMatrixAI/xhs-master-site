...
const sharedPlanningRules = [
  "生成的是可发展成小红书生活分享的选题，不得写成运营方案、说明书、服务手册、销售话术或内部策划语言。不能使用理性分析的句式和语气，要突出活人感、“分享真实生活”，避免平铺直叙，适当情绪化和夸张的语气。",
  ...
  stay: [
    {
      ...
      planningRules: [
        ...
        "不得使用“对于选择民宿，我会先看 XX”的句式，要以真人或朋友分享的语气表达。",
        "不能一味介绍民宿本身，可从亲子友好、宠物友好、逃离城市躲进乡村的生活方式等角度出发。",
    ...
    },
    {
      ...
      planningRules: [
        ...
        "不得以周边信息为重点，要以住在这里的真实感受、停留节奏和生活体验为重点；可从亲子友好、宠物友好、逃离城市躲进乡村的生活方式等角度出发。",
    ...
    },
    {
      ...
      planningRules: [
        "本目标只讲民宿所在旅游区的风景、景点、自然环境或可确认旅游资源；不得介绍民宿房型、外观、院子、公共区或预订信息。",
        "不得把民宿作为内容主体、镜头主体或叙事落点，也不得将住宿推荐、预订、房态、价格和套餐写入正文主线。",
        "不得写成完整旅游攻略、景点清单、交通地图、行程安排或景区宣传稿；应围绕一个具体景色、时段、季节或在地体验展开，重点介绍景观特点、描述对风景的真实感受和体验。",
        "不得虚构景点距离、开放状态或当地活动。"
      ]
    },
    {
  ...
  food: [
    {
      ...
      planningRules: [
        ...
        "不得把同一道菜机械拆成菜品介绍、分享说明、人数说明和活动说明；多篇任务必须从风味、口感、食材、食材来源、火候、搭配或自然聚餐感中选择不同切入点。",
    ...
    },
    {
      ...
      planningRules: [
        ...
        "不得把适合几个人、坐在哪里、怎么分菜作为笔记主要内容。",
        "重点突出真实的放松、聊天场景；可选择构建氛围感、仪式感或停留感。"
      ]
    }
  ],
  outdoor: [
    {
      ...
      planningRules: [
        "不得写成说明文，一半篇幅需要描绘路线特点、景色描述和自己的体会感受；装备攻略、注意事项和避坑经验等信息是次要的。",
