...
- account.city 只是账号经营背景和事实参考，不代表每篇选题都要体现所在地。topicTitle 应优先突出具体对象、体验、场景、情绪、问题或用户收益，不要习惯性使用“地名 + 内容主题”结构。
- 当内容确实围绕具体目的地、路线、门店、区域活动或本地服务时，可以自然使用地名；contentGoal、coreView 和素材要求中也应保留对内容有用的地点事实。
- topicTitle 只是后续创作的内容主题参考，不是待改写的半成品标题。同一周的 topicTitle 应避免重复相同开头、句式、核心钩子和“地名 + 主题”结构。
